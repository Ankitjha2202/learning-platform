...
import { Box, Grid, Heading, Stack ,HStack, Progress} from '@chakra-ui/react'
...
const Databox =({title,qty,qtyPercentage,profit})=>(
    <Box w={["full","60"]} padding={'1'} boxShadow={'-2px 0 10px rgba(107,70,193,0.5)'} borderRadius={'lg'}>
        <Text children={title}/>
